...
class MircopostsControllerTest < ActionController::TestCase
  ...
  test "should create mircopost" do
    assert_difference('Mircopost.count') do
      post :create, mircopost: { content: @mircopost.content, string: @mircopost.string, user_id: @mircopost.user_id }
    end
  ...
  test "should update mircopost" do
    patch :update, id: @mircopost, mircopost: { content: @mircopost.content, string: @mircopost.string, user_id: @mircopost.user_id }
    assert_redirected_to mircopost_path(assigns(:mircopost))
  end
